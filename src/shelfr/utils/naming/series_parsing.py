...
if TYPE_CHECKING:
    from shelfr.models import SeriesInfo

from shelfr.utils.naming.constants import (
    SERIES_FROM_TITLE_PATTERNS,
    VOL_FROM_NAME_PATTERN,
)
from shelfr.utils.naming.normalization import clean_series_name
...
def parse_series_from_libation_path(
    ...
    for idx in range(start_idx, end_idx - 1, -1):
        ...
        common_roots = {
            ...
            "staging",
            "upload",
            # Common mount points and system paths (prevent /mnt/user/... false positives)
            "mnt",
            "user",
            "home",
            "root",
...
def resolve_series(
    ...
    from shelfr.models import SeriesInfo, SeriesSource
